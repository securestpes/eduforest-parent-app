...
import { Button, Switch, Text, useTheme, TouchableRipple, Card, Icon } from 'react-native-paper';
...
export function ProfileScreen() {
  ...
  const openLegalScreen = (screen: keyof Pick<RootStackParamList, 'PrivacyPolicy' | 'TermsAndConditions' | 'HelpAndSupport'>) => {
    navigation.getParent<NavigationProp<RootStackParamList>>()?.navigate(screen);
  };
  ...
  const handleConfirmDeleteAccount = () => {
    void (async () => {
      ...
      try {
        ...
        Alert.alert('', msg.includes('Delete account') ? msg : t('settings.deleteAccount.failed'));
      } finally {
  ...
  return (
    <ScreenDecor>
      ...
      >
        ...
        >
          <Card.Content>
            <Text variant="titleMedium" style={[styles.languageTitle, { color: theme.colors.onSurface }]}>
              {t('settings.language.title')}
            </Text>
            <Text variant="bodyMedium" style={[styles.languageSubtitle, { color: theme.colors.onSurfaceVariant }]}>
        ...
        <Pressable onPress={() => openLegalScreen('TermsAndConditions')}>
          <View style={[styles.infoCard, { backgroundColor: theme.colors.surface, borderColor: theme.colors.outlineVariant }]}>
            <View style={[styles.infoIcon, { backgroundColor: theme.colors.secondaryContainer }]}>
              <MaterialCommunityIcons name="file-document-outline" size={22} color={theme.colors.secondary} />
            </View>
            <View style={{ flex: 1 }}>
              <Text variant="titleSmall" style={{ color: theme.colors.onSurface, fontWeight: '700' }}>
        ...
        <Pressable onPress={() => openLegalScreen('HelpAndSupport')}>
          <View style={[styles.infoCard, { backgroundColor: theme.colors.surface, borderColor: theme.colors.outlineVariant }]}>
            <View style={[styles.infoIcon, { backgroundColor: theme.colors.tertiaryContainer }]}>
              <MaterialCommunityIcons name="help-circle-outline" size={22} color={theme.colors.tertiary} />
            </View>
            <View style={{ flex: 1 }}>
              <Text variant="titleSmall" style={{ color: theme.colors.onSurface, fontWeight: '700' }}>
                {t('profile.helpTitle')}
          ...
          >
            ...
            >
              <Card.Content style={styles.deleteAccountContent}>
                <View style={[styles.deleteAccountIconContainer, { backgroundColor: `${theme.colors.error}12` }]}>
                  <Icon source="account-remove-outline" size={20} color={theme.colors.error} />
                </View>
                <View style={styles.deleteAccountTextContainer}>
                  <Text variant="titleMedium" style={[styles.deleteAccountTitle, { color: theme.colors.error }]}>
                    {t('settings.deleteAccount.title')}
                  </Text>
                  <Text variant="bodyMedium" style={[styles.deleteAccountSubtitle, { color: theme.colors.onSurfaceVariant }]}>
