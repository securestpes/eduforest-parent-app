...
import type { ChildHubSection } from '../../../navigation/navigationRef';
...
type QuickStartItem = {
  ...
  destination:
    ...
    | { type: 'hub'; section: ChildHubSection };
};
            ...
            <Card.Content style={styles.addressContent}>
              ...
              >
                <Icon
                  ...
                  size={24}
                  color={theme.palette.card4_base}
                />
              </View>
              <View style={{ flex: 1 }}>
                <Text style={styles.contactTitle}>
